...
class _SingleStageDetector(BaseDetector):
    ...
    def __init__(self,
        ...
        super(_SingleStageDetector, self).__init__(init_cfg)
        if pretrained:
    ...
    def forward_train(self,
        ...
        """
        super(_SingleStageDetector, self).forward_train(img, img_metas)
        x = self.extract_feat(img)
...
@DETECTORS.register_module()
class SingleStageDetector(_SingleStageDetector):
    ...
    def forward_train(self,
        ...
        for i,x in enumerate(xs):
            ...
            if len(xs) > 1:
                head_losses = upd_loss(head_losses, idx=i, weight=loss_weights[i])                            
            losses.update(head_losses)

        # print(losses)

        # if bug, key-value wise addition
